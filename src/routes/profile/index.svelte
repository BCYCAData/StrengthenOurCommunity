...
<p class="m-2 sm:text-lg">This information is confidential and will be owned and updated by you.</p>
<p class="m-2 sm:text-lg">
...
<p class="m-2 sm:text-lg text-center">
...
<p class="m-2 sm:text-lg text-center">Thanks for your time and comments.</p>
